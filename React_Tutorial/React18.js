...
//On line 52, delete the string "change me!" and reassign the answer const so your code randomly accesses a different index of the possibleAnswers array each time the component updates. Finally, insert the answer const inside the p tags.
//Original
const inputStyle = {
  width: 235,
  margin: 5
...
class MagicEightBall extends React.Component {
  ...
  render() {
    ...
    //See above. there was already a random math function in the ask() method. 
